...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.Surface((20, 50)).convert().fill("Black")
        print(type(self.image), "enemy")
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.surface.Surface((20, 20)).convert().fill("Yellow")
        print(type(self.image), "coin")
